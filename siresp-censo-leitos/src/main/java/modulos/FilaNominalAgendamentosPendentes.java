...
public class FilaNominalAgendamentosPendentes {
	...
	{			
		...
		opcoes.add("Agendamentos Pendentes");
	...
	private String baixarArquivos(WebDriver driver, AcoesGeraisPaginaWeb paginaWeb, EntidadeCDRNaoRegulada entidade) 
	{
		...
		{
			paginaWeb.selecionarItemSelect(driver, IdentificadoresPaginaWebSIRESP.ID_AMBULATORIAL_REGULADA_AGENDAMENTOS_FILTRO_TIPO_CONSULTA_EXAME.getTextoIdentificador(), tiposDeBusca[i]);
