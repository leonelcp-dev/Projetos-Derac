...
public enum ParametrosArquivoUrgenciaPlanilhaProducaoRegulador {
	...
	NOME_PLANILHA_MONITORAMENTO(22, 0, "Produção Regulador", "", ""),
	...
	ParametrosArquivoUrgenciaPlanilhaProducaoRegulador(int idUnico, int indice, String descricao, String tipo, String formato)
	{
    ...
    private static final Map<Integer, ParametrosArquivoUrgenciaPlanilhaProducaoRegulador> POR_ID_UNICO =
        Arrays.stream(values()).collect(Collectors.toUnmodifiableMap(ParametrosArquivoUrgenciaPlanilhaProducaoRegulador::getIdUnico, Function.identity()));

    public static ParametrosArquivoUrgenciaPlanilhaProducaoRegulador poIdUnico(int idUnico) {
