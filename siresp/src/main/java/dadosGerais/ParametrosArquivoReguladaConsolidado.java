...
public enum ParametrosArquivoReguladaConsolidado {
	...
	INDICE_COLUNA_ESPECIALIDADE_EXAME(4, 4, "Especialidade/Exame", "String", ""),
	INDICE_COLUNA_HIPOTESE(5, 5, "Hipótese", "String", ""),
	INDICE_COLUNA_ARQUIVO(6, 6, "Arquivo", "String", ""),
	INDICE_COLUNA_DATA_ARQUIVO(7, 7, "ArqRef", "Date", "dd/MM/yyyy"),
