	...
	public ArrayList<CorrelacaoColunasOfertasDemandas> obterCorrelacaoEntreArquivos(String consultaOuExame, String vinculo)
	{
		...
		if(vinculo.equals(IdentificadoresPaginaWebSIRESP.TEXTO_VINCULO_ESTADUAL.getTextoIdentificador()))
		{
			if(consultaOuExame.equals("Exame")) //Exame em unidade estadual
			{
				...
				correlacoes.add(new CorrelacaoColunasOfertasDemandas(ParametrosArquivoOfertaDemanda.INDICE_COLUNA_OFERTA_SIRESP.getIndice(), ParametrosTabelaProducaoExecutanteExames.INDICE_COLUNA_OFERTA_TOTAL.getIndice(), ParametrosArquivoOfertaDemanda.INDICE_COLUNA_OFERTA_SIRESP.getTipo(), ParametrosArquivoOfertaDemanda.INDICE_COLUNA_OFERTA_SIRESP.getFormato()));
			...
			else if(consultaOuExame.equals("Consulta")) //Consulta em unidade estadual
			{
				...
				correlacoes.add(new CorrelacaoColunasOfertasDemandas(ParametrosArquivoOfertaDemanda.INDICE_COLUNA_OFERTA_SIRESP.getIndice(), ParametrosTabelaProducaoExecutanteConsultas.INDICE_COLUNA_OFERTA_TOTAL.getIndice(), ParametrosArquivoOfertaDemanda.INDICE_COLUNA_OFERTA_SIRESP.getTipo(), ParametrosArquivoOfertaDemanda.INDICE_COLUNA_OFERTA_SIRESP.getFormato()));
		...
		else
		{
			if(consultaOuExame.equals("Exame")) //exame em unidades não estaduais
			{
				...
				correlacoes.add(new CorrelacaoColunasOfertasDemandas(ParametrosArquivoOfertaDemanda.INDICE_COLUNA_OFERTA_SIRESP.getIndice(), ParametrosTabelaProducaoConsolidadoExames.INDICE_COLUNA_OFERTA.getIndice(), ParametrosArquivoOfertaDemanda.INDICE_COLUNA_OFERTA_SIRESP.getTipo(), ParametrosArquivoOfertaDemanda.INDICE_COLUNA_OFERTA_SIRESP.getFormato()));
			...
			else if(consultaOuExame.equals("Consulta"))
			{
				...
				correlacoes.add(new CorrelacaoColunasOfertasDemandas(ParametrosArquivoOfertaDemanda.INDICE_COLUNA_OFERTA_SIRESP.getIndice(), ParametrosTabelaProducaoConsolidadoConsultas.INDICE_COLUNA_OFERTA_PRIMEIRA_CONSULTA.getIndice(), ParametrosArquivoOfertaDemanda.INDICE_COLUNA_OFERTA_SIRESP.getTipo(), ParametrosArquivoOfertaDemanda.INDICE_COLUNA_OFERTA_SIRESP.getFormato()));
