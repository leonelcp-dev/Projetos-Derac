...
public enum IdentificadoresPaginaWebGEFIC {
	...
	XPATH_FILAS_CHECK_BOX_POSICAO(1, "/html/body/div[1]/div/div[2]/div[2]/div/div/div/div[3]/div[1]/div[2]/div/div/label[1]/input"),
	XPATH_FILAS_CHECK_BOX_TELEFONE(2, "/html/body/div[1]/div/div[2]/div[2]/div/div/div/div[3]/div[1]/div[2]/div/div/label[2]/input"),
	XPATH_FILAS_CHECK_BOX_DATA_NASCIMENTO(3, "/html/body/div[1]/div/div[2]/div[2]/div/div/div/div[3]/div[1]/div[2]/div/div/label[3]/input"),
	XPATH_FILAS_CHECK_BOX_IDADE(4, "/html/body/div[1]/div/div[2]/div[2]/div/div/div/div[3]/div[1]/div[2]/div/div/label[4]/input"),
	XPATH_FILAS_CHECK_BOX_PRIORIZACAO(5, "/html/body/div[1]/div/div[2]/div[2]/div/div/div/div[3]/div[1]/div[2]/div/div/label[5]/input"),
	XPATH_FILAS_CHECK_BOX_ESPECIALIDADE(6, "/html/body/div[1]/div/div[2]/div[2]/div/div/div/div[3]/div[1]/div[2]/div/div/label[6]/input"),
	XPATH_FILAS_CHECK_BOX_SUBESPECIALIDADE(7, "/html/body/div[1]/div/div[2]/div[2]/div/div/div/div[3]/div[1]/div[2]/div/div/label[7]/input"),
	XPATH_FILAS_CHECK_BOX_PROCEDIMENTO(8, "/html/body/div[1]/div/div[2]/div[2]/div/div/div/div[3]/div[1]/div[2]/div/div/label[8]/input"),
	XPATH_FILAS_CHECK_BOX_CID(9, "/html/body/div[1]/div/div[2]/div[2]/div/div/div/div[3]/div[1]/div[2]/div/div/label[9]/input"),
	XPATH_FILAS_CHECK_BOX_DATA_INDICACAO(10, "/html/body/div[1]/div/div[2]/div[2]/div/div/div/div[3]/div[1]/div[2]/div/div/label[10]/input"),
	XPATH_FILAS_CHECK_BOX_DATA_INSERCAO(11, "/html/body/div[1]/div/div[2]/div[2]/div/div/div/div[3]/div[1]/div[2]/div/div/label[11]/input"),
	XPATH_FILAS_CHECK_BOX_DATA_EXECUCAO(12, "/html/body/div[1]/div/div[2]/div[2]/div/div/div/div[3]/div[1]/div[2]/div/div/label[12]/input"),
	XPATH_FILAS_CHECK_BOX_DATA_SAIDA(13, "/html/body/div[1]/div/div[2]/div[2]/div/div/div/div[3]/div[1]/div[2]/div/div/label[13]/input"),
	XPATH_FILAS_CHECK_BOX_ESTABELECIMENTO(14, "/html/body/div[1]/div/div[2]/div[2]/div/div/div/div[3]/div[1]/div[2]/div/div/label[14]/input"),
	XPATH_FILAS_CHECK_BOX_SITUACAO(15, "/html/body/div[1]/div/div[2]/div[2]/div/div/div/div[3]/div[1]/div[2]/div/div/label[15]/input"),
	XPATH_FILAS_CHECK_BOX_CIDADE(16, "/html/body/div[1]/div/div[2]/div[2]/div/div/div/div[3]/div[1]/div[2]/div/div/label[16]/input"),
	XPATH_FILAS_CHECK_BOX_TELEFONE_ADICIONAL_1(17, "/html/body/div[1]/div/div[2]/div[2]/div/div/div/div[3]/div[1]/div[2]/div/div/label[17]/input"),
	XPATH_FILAS_CHECK_BOX_TELEFONE_ADICIONAL_2(18, "/html/body/div[1]/div/div[2]/div[2]/div/div/div/div[3]/div[1]/div[2]/div/div/label[18]/input"),
	XPATH_FILAS_CHECK_BOX_UNIDADE_BASICA_REFERENCIA(19, "/html/body/div[1]/div/div[2]/div[2]/div/div/div/div[3]/div[1]/div[2]/div/div/label[19]/input"),
	XPATH_FILAS_CHECK_BOX_UNIDADE_SOLICITANTE(20, "/html/body/div[1]/div/div[2]/div[2]/div/div/div/div[3]/div[1]/div[2]/div/div/label[20]/input"),
	XPATH_FILAS_CHECK_BOX_TEMPO_DE_ESPERA(21, "/html/body/div[1]/div/div[2]/div[2]/div/div/div/div[3]/div[1]/div[2]/div/div/label[21]/input"),
	XPATH_FILAS_CHECK_BOX_TEMPO_MEDIO_DE_ESPERA(22, "/html/body/div[1]/div/div[2]/div[2]/div/div/div/div[3]/div[1]/div[2]/div/div/label[22]/input"),
	XPATH_FILAS_CHECK_BOX_TEMPO_MAXIMO_DE_ESPERA(23, "/html/body/div[1]/div/div[2]/div[2]/div/div/div/div[3]/div[1]/div[2]/div/div/label[23]/input"),
	XPATH_FILAS_CHECK_BOX_OBSERVACOES(24, "/html/body/div[1]/div/div[2]/div[2]/div/div/div/div[3]/div[1]/div[2]/div/div/label[24]/input"),
	XPATH_FILAS_CHECK_BOX_ACOES(25, "/html/body/div[1]/div/div[2]/div[2]/div/div/div/div[3]/div[1]/div[2]/div/div/label[25]/input"),
	...
	TEXTO_STATUS_PROCEDIMENTO_REALIZADO(0, "Procedimento realizado"),
	TEXTO_STATUS_AGUARDANDO_NA_FILA(0, "Aguardando na fila"),
	TEXTO_STATUS_TODOS(0, "Todos (aguardando, cancelados e realizados)");
