...
public enum ParametrosArquivoDemandaReprimidaFilipetasNaoImpressas {
	...
	INDICE_COLUNA_DATA_AGENDA(13, 13, "Data Entrada", "Date", "yyyy-MM-dd"),
	INDICE_COLUNA_HORARIO(14, 14, "Horário", "Time", "HH:mm:ss"),
	INDICE_COLUNA_STATUS(15, 15, "Status", "String", ""),
	INDICE_COLUNA_PRIORIDADE(16, 16, "Prioridade", "String", ""),
	INDICE_COLUNA_OBSERVACAO(17, 17, "Observação", "String", ""),
	INDICE_COLUNA_OBSERVACAO_STATUS(18, 18, "Observação Status", "String", ""),
	INDICE_COLUNA_TELEFONE(19, 19, "Telefone", "String", ""),
	INDICE_COLUNA_MUNICIPIO(20, 20, "Município", "String", ""),
	
	LINHA_INICIAL_PLANILHA_CDR(21, 1,"Ajustado de acordo com o Java, no arquivo é a linha 2", "", ""),
	LINHA_INICIAL_TABELA_DINAMICA(22, 3,"Ajustado de acordo com o Java, no arquivo é a linha 4", "", ""),
	
	INDICE_COLUNA_CONSOLIDADO_ESPECIALIDADE(23, 0, "Especialidade", "String", ""),
	INDICE_COLUNA_CONSOLIDADO_CONTAGEM_ESPECIALIDADE(24, 1, "Contagem Especialidade", "Int", ""),
	INDICE_COLUNA_CONSOLIDADO_MAX_TEMPO_ESPERA(25, 2, "Max Tempo Espera", "Int", ""),

	NOME_PLANILHA_FILIPETAS_NAO_IMPRESSAS(26, 0, "FILIPETAS NÃO IMPRESSAS", "", ""),
