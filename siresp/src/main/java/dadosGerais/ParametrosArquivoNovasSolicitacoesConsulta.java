...
public enum ParametrosArquivoNovasSolicitacoesConsulta {
	...
	ParametrosArquivoNovasSolicitacoesConsulta(int idUnico, int indice, String descricao, String tipo, String formato)
	{
    ...
    private static final Map<Integer, ParametrosArquivoNovasSolicitacoesConsulta> POR_ID_UNICO =
        Arrays.stream(values()).collect(Collectors.toUnmodifiableMap(ParametrosArquivoNovasSolicitacoesConsulta::getIdUnico, Function.identity()));

    public static ParametrosArquivoNovasSolicitacoesConsulta poIdUnico(int idUnico) {
