...
public enum ParametrosArquivoUrgenciaPlanilhaFinalizadoDetalhado {
	...
	NOME_PLANILHA_MONITORAMENTO(22, 0, "Detalhado Urgência Finalizado", "", ""),
	...
	ParametrosArquivoUrgenciaPlanilhaFinalizadoDetalhado(int idUnico, int indice, String descricao, String tipo, String formato)
	{
    ...
    private static final Map<Integer, ParametrosArquivoUrgenciaPlanilhaFinalizadoDetalhado> POR_ID_UNICO =
        Arrays.stream(values()).collect(Collectors.toUnmodifiableMap(ParametrosArquivoUrgenciaPlanilhaFinalizadoDetalhado::getIdUnico, Function.identity()));

    public static ParametrosArquivoUrgenciaPlanilhaFinalizadoDetalhado poIdUnico(int idUnico) {
