...
public enum ParametrosArquivoDemandaReprimidaRegulada {
	...
	INDICE_COLUNA_UNIDADE_TIPO(5, 5, "UNIDADE TIPO", "String", ""),
	INDICE_COLUNA_UNIDADE_SOLICITANTE(6, 6, "Unidade Solicitante", "Int", ""),
	INDICE_COLUNA_NOME_FICHA(7, 7, "Nome Ficha", "String", ""),
	INDICE_COLUNA_GRUPO_DE_COTAS_E_ESPECIALIDADES_NOMENCLATURA(8, 8, "GRUPO DE COTAS E ESPECIALIDADES.NOMENCLATURA", "String", ""),
	INDICE_COLUNA_ESPECIALIDADE_EXAME(9, 9, "Especialidade/Exame", "String", ""),
	INDICE_COLUNA_HIPOTESE(10, 10, "Hipótese", "String", ""),
	...
	AREA_PARA_TABELA_DINAMICA_REGULADA(26, 0, "A1:K", "", ""),
