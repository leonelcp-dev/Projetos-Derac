...
public class RemoverDuplicadoDeFila {
	...
	{			
		...
		EntidadeCDRNaoRegulada centralReg = new EntidadeCDRNaoRegulada("2046318", "CS DIC III", "SUDOESTE", "CS DIC III");
						...
						if(codigoPaciente.equals(entradaDeFila.codigo))
						{
							...
							for(ArrayList<String> linhaDaTabelaConsulta : tabelaDeResultadosConsultas)
							{
								...
								if(linhaDaTabelaConsulta.size() >= ParametrosTabelaCDRRegulacoesConsulta.QUANTIDADE_ESPERADA_DE_COLUNAS.getIndice())
								{
									...
									System.out.println(unidade + "|" + nomeSIRESP + "|");
									...
									System.out.println(dataEntrada + "|" + entradaDeFila.dataEntrada.toUpperCase().substring(0, 10) + " 00:00" + "|");
									System.out.println(IdentificadoresPaginaWebSIRESP.TEXTO_USUARIO_IMPORTACAO_MANUAL.getTextoIdentificador() + "|" + usuario.toUpperCase() + "|");
									
									if(nomeSIRESP.equals(unidade.toUpperCase()) &&
									   ...
									   IdentificadoresPaginaWebSIRESP.TEXTO_USUARIO_IMPORTACAO_MANUAL.getTextoIdentificador().equals(usuario.toUpperCase()))
									{
										...
										if(quantidadeEncontrada > 1)
										{
											...
											paginaWeb.preencherInputText(driver, IdentificadoresPaginaWebSIRESP.ID_CADASTRO_DEMANDA_POR_RECURSO_OBSERVACAO_ALTERACAO_HISTORICO.getTextoIdentificador(), IdentificadoresPaginaWebSIRESP.TEXTO_CADASTRO_DEMANDA_POR_RECURSO_OBSERVACAO_REMOCAO_POR_DUPLICACAO.getTextoIdentificador());
											...
											retornoProcesso = "Mantido 1 importação e removido " + (quantidadeEncontrada - 1) + " por duplicação na importação";
										}
										else
											retornoProcesso = "Mantido 1 importação";
									}
								}
